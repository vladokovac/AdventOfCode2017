/**
 * Created by vlado on 11/12/2017.
 */
public class PuzzleInputs {
    ...
    public static String day2 = "121\t59\t141\t21\t120\t67\t58\t49\t22\t46\t56\t112\t53\t111\t104\t130\n" +
    ...
    public static int day3 = 325489;
    public static String day7 = "yjmbbu (75)\n" + "zdhvqrl (40) -> fpbsu, fwpfjjd, viqhfi\n" + "dywqvqh (9)\n" +
            "gewgn (31)\n" +
            "xfekjt (67)\n" + "zezowe (31)\n" + "wgqkdcr (79)\n" + "ljhwzvv (258)\n" +
            ...
            "hhmwlo (56)\n" + "icgwppo (84)";
    public static String day8 = "ebu inc 626 if iq < 0\n" +
    ...
    public static String day9 = "{{{{{{{<!!\"!!!>},<>},{<o!>},<u!!i!!'!>,<!!!>,e{'e!!!>},<!i>}},{{<\"o!!\"!>,<>}," +
            "<!io<>},{{},<!!!>!>,<o\"e!<!!!>{,!!!>{a!o,au!>},<>}}},{{{<e!}>},{{<!>,,e!!!>!!,>},{<a!!!>'!!!>!!!!,!!!>!!!>!>}," +
            "<<{\"!!>}},{{<!>>,<!>},<i!>!<>},{<!!<u,a\"!>},<o{{!!{!!!>i,!>,<i{!u>,{<a!>e}o!>!>e>}}}},{{<i<!>,<!!!>,<ei," +
            "!>a>,{}},{<!!!>},<e'>,{}},{{<!!!!u<,'}!>,<\"o<>}}}},{{{{{{<!>,<o!!!auii!!!!!>!!!>,<{>}},<},!!!>!!!!!>>}," +
            "{<'u<\"{>,{<!!!!e!>,<'a!!i<!>,>}},{}},{{<i}<!u<{!!!}!!e!{!,>}},{<!!e,!>i>,{}}},{{<i!!!>},<{''i!!!>,!e!>}," +
            "<!>\"a{>,<!!'u!!!>},<>}},{{{},<i!>},<<!>},<\">},{{<!>,<o!!!!e{uee!!}o<ei{i!>,<!!!>,<>},<,!>},<a!>>},{{}," +
            "{<}i,!'!!<!!!>}>}}}},{{{{{},{},{{<i!>,<!\"!!!>!!!>''>,{}},{{<!>},<u!a!!!>!u!\"'!!{!!!>!!!>!!i!!!>,<," +
            "a!!!>i!>},<\">,{}},{<!!!eoo!!!!ai'!!u!!!>!o>,{<,!!!>aai}{}}\"'>}},{{},<i'ia,!!!>o!>,<\"!!u!>>}}," +
            "{<!!!>{u!!!>,<,<!>},<'<}<'\"!>},<!u>}}},{{{{<}!!a}!>},<'>},{}},{{{{{},{{<i{!'u}}{>,{{{{<}!>," +
            "<!!!!uau!{''!!}ua>}}},{}}},{{{<!!},!!\"\"!!!>,<i!'!{!>},<o>},{<a!u!!\"<!>},<\"!,{<<e!!<!!u!>}," +
            "<!o!!{}>}}}}},<,o}!>,<!!!!'!'a!!{>}},{{{<<>},{{<ui{!!i!>{'!!!>},<'>}}},{<{!!!>},<!a!e!!!>o'i!!<'!>," +
            "<o!!e!!\"!>,<!>>},{<{a>}}}},{{{{<\"{!!!>,e!!!>\"a!!}!!!,!>>},<o!!!>>},{{<o!{}!!!>},<!!,!!\",!>!!!>!>," +
